...
/***/ function(module, exports, __webpack_require__) {
	...
	const SheetConfigure_1 = __webpack_require__(3);
	const Sheet_1 = __webpack_require__(5);
	const Operator_1 = __webpack_require__(4);
	const Sheet_2 = __webpack_require__(5);
	let sheet;
	function start() {
	    if (sheet) {
	    ...
	    let config = new SheetConfigure_1.default();
	    ...
	    config.operators = [Operator_1.default.PLUS, Operator_1.default.MINUS];
	    if ($('#multipleFlag').prop('checked')) {
	        config.operators.push(Operator_1.default.MULTIPLE);
	    }
	    config.timeLimit = $('#timeLimit').val();
	    sheet = new Sheet_1.default(config);
	    sheet.on(Sheet_2.EVENT_START, () => {
	        resetForm();
	        renderExpressions();
	        renderTime();
	    });
	    sheet.on(Sheet_2.EVENT_TIMEOUT, () => {
	        alert('时间到！答题结束！');
	        postResult();
	    });
	    sheet.on(Sheet_2.EVENT_TIMEPASS, (event, passTime) => {
	        $('#passTime').html('已用: ' + passTime);
	    });
	    sheet.on(Sheet_2.EVENT_SUBMITTED, () => {
...
/***/ function(module, exports, __webpack_require__) {
	...
	class SheetConfiure {
	    constructor() {
	        ...
	        this.operators = [Operator_1.default.PLUS, Operator_1.default.MINUS, Operator_1.default.MULTIPLE];
	        this.timeLimit = 0;
	    }
	    toJSON() {
	        let serializeObj = {
	...
	exports.SheetConfiure = SheetConfiure;
	Object.defineProperty(exports, "__esModule", { value: true });
	exports.default = SheetConfiure;
...
/***/ function(module, exports) {
	...
	Operator.MULTIPLE = new Operator('x');
	Operator.ALL = [Operator.PLUS, Operator.MINUS, Operator.MULTIPLE];
...
/***/ function(module, exports, __webpack_require__) {
	...
	"use strict";
	const DelayTasks_1 = __webpack_require__(6);
	const Observable_1 = __webpack_require__(7);
	const ExpressionCreator_1 = __webpack_require__(8);
	const Serializer_1 = __webpack_require__(10);
	exports.EVENT_START = 'start';
	exports.EVENT_SUBMITTED = 'submitted';
	exports.EVENT_TIMEOUT = 'timeout';
	exports.EVENT_TIMEPASS = 'timepass';
	const TASK_AUTO_SUBMIT = 'auto-submit';
	const TASK_USED_TIME = 'used-time';
	class Sheet extends Observable_1.default {
	    constructor(config) {
	        super();
	        this._config = config;
	        this._expressions = [];
	        this._tasks = new DelayTasks_1.default();
	    ...
	    start() {
	        ...
	        if (config.timeLimit > 0) {
	            tasks.addSimpleTask(TASK_AUTO_SUBMIT, () => {
	                this.fire(exports.EVENT_TIMEOUT);
	            }, config.timeLimit * config.itemCount * 60000);
	        }
	        tasks.addRepeatTask(TASK_USED_TIME, () => {
	            sheet.fire(exports.EVENT_TIMEPASS, sheet.passedTimeString);
	        }, 1000);
	        this.fire(exports.EVENT_START);
	    }
	    submit(results) {
	        let sheet = this;
	        if (sheet._submitted) {
	        ...
	        this.submitted = true;
	        this.sendResult();
	        this.fire(exports.EVENT_SUBMITTED);
	    }
	    generateExpressions() {
	        let expressions = this.expressions;
	        let config = this.config;
	        let creator = new ExpressionCreator_1.default(config);
	        for (let i = 0; i < config.itemCount; i++) {
...
/***/ function(module, exports) {
	...
	class DelayTasks {
	    ...
	    addTask(taskName, func, delay, repeat = false) {
	        let self = this;
	        if (repeat) {
	    ...
	    addSimpleTask(taskName, func, delay) {
	        let self = this;
	    ...
	    addRepeatTask(taskName, func, delay) {
	        let self = this;
	    ...
	    addAwaitingTask(taskName, func, waitingFunc, delay) {
	        let self = this;
...
/***/ function(module, exports, __webpack_require__) {
	...
	class ExpressionCreator {
	    ...
	    createSimpleExpression() {
	        ...
	        let left, right;
	        switch (operator) {
	            case Operator_1.default.MULTIPLE:
	        ...
	        return new Expression_1.default(left, right, operator);
	    }
	    createComplexExpression(degree = 0) {
	        let config = this.config;
	        let max = config.max;
	        let min = config.min;
	        let multipleDigitalBit = config.multipleDigitalBit;
	        ...
	        let left = this.createComplexExpression(degree - 1);
	        let operator = randomOperator(config.operators);
	        let right;
	        switch (operator) {
	            case Operator_1.default.MULTIPLE:
	...
	Object.defineProperty(exports, "__esModule", { value: true });
	exports.default = ExpressionCreator;
...
/***/ function(module, exports, __webpack_require__) {
	...
	class Expression {
	    ...
	    toString() {
	        ...
	        if (self.operator == Operator_1.default.MULTIPLE) {
	            if (self.left instanceof Expression) {
	                let leftExpr = (self.left);
	                if (leftExpr.operator == Operator_1.default.PLUS || leftExpr.operator == Operator_1.default.MINUS)
	                    left = '(' + left + ')';
	            }
	        }
	        if (self.right instanceof Expression) {
	            let rightExpr = (self.right);
	            if (rightExpr.operator == Operator_1.default.PLUS || rightExpr.operator == Operator_1.default.MINUS) {
	                right = '(' + right + ')';
	            }
	        }
	    ...
	    calcResult() {
	        ...
	        let result;
	        if (self.left instanceof Expression) {
	            leftNumber = (self.left).calcResult();
	        }
	        else {
	            leftNumber = (self.left);
	        }
	        if (self.right instanceof Expression) {
	            rightNumber = (self.right).calcResult();
	        }
	        else {
	            rightNumber = (self.right);
	        }
	        switch (self.operator) {
	            ...
	            case Operator_1.default.MINUS:
	                ...
	                break;
	            case Operator_1.default.MULTIPLE:
	                result = multiple(leftNumber, rightNumber);
	                break;
	        }
	        return result;
	    }
...
/***/ function(module, exports, __webpack_require__) {
	...
	"use strict";
	const Serializable_1 = __webpack_require__(11);
	const md5 = __webpack_require__(12);
	const classRegistry = {};
	class ClassRegistration {
	    constructor(name, clazz, ignoredFields = []) {
	        this.name = name;
	        this.clazz = clazz;
	        this.ignoredFields = ignoredFields;
	    }
	}
	const defaultClassRegistration = new ClassRegistration('Serializable', Serializable_1.default);
	...
	class Serializer {
	    ...
	    static generateClassRegName(clazz) {
	    ...
	    serializeSingleObject(object, context) {
	        ...
	        let tgtObj = { "class": Serializer.getClassRegistration(object.constructor).name, "data": dataObj };
	    ...
	    convertValueForSerialize(value, context) {
	        if (value instanceof Serializable_1.default || value instanceof Array || value.constructor === Object) {
	    ...
	    isFieldSerializable(object, field) {
	        ...
	        if (typeof value === 'object') {
	            ...
	            if (!(value instanceof Serializable_1.default)) {
	                return false;
	            }
	        }
	        return true;
	    ...
	    deserializeSingleObj(serialObj, refArray) {
...
/***/ }
/******/ ]);
//# sourceMappingURL=calc-sheet.js.map